...
RZP_KEY_ID = os.getenv("RZP_KEY_ID", "rzp_live_Rfe6IjnX0n3ToN")
RZP_KEY_SECRET = os.getenv("RZP_KEY_SECRET", "bNwyMG7yUeFBmk68qLqTFRH0")
RAZORPAY_KEY = RZP_KEY_ID
RAZORPAY_SECRET = RZP_KEY_SECRET
RAZORPAY_WEBHOOK_SECRET = os.getenv("RAZORPAY_WEBHOOK_SECRET", "5LxGcqbpgqHC@CJ")
